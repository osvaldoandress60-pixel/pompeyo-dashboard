...
function guardarEdicion(e) {
    ...
    const fechaFacturaCND = document.getElementById("edit-fecha-factura").value;
    if (facturaSino === "si" && !fechaFacturaCND) {
        ...
        v["Fecha Factura CND"] = fechaFacturaCND;
    }
...
function agregarVehiculo(e) {
    ...
    datosOriginales.push({
        ...
        "Fecha Factura CND": document.getElementById("new-factura-sino").value === "si" ? (() => { const hoy = new Date().toISOString().split('T')[0]; document.getElementById("new-fecha-factura").value = hoy; return hoy; })() : "",
